...
python excelreader.py --excelfile age-breakdown.xlsx --sheetname "Chart for question 5" --collection Q5 --drop --mincol 1 --maxcol 6 --minrow 7 --maxrow 12 --host ${MDBHOST}
